...
const EditCharacterPage: NextPage = () => {
  ...
  //     </Flex>
  //       {/* Fila Imagen */}
  //       <Grid templateColumns="12fr" gap={6} p={5}>
  ...
  //               +3
  //             </Text>
  //             <Input value={16} variant='filled' textAlign="center" width={14} fontSize="md" />
  //           </InputGroup>
  //         </Box>
  //         <Box>
  //           <InputGroup border="1px solid white" display="flex" flexDirection="column" alignItems="center">
  ...
  //               +3
  //             </Text>
  //             <Input variant='filled' value={16} textAlign="center" width={14} fontSize="md" />
  //           </InputGroup>
  //         </Box>
  //         <Box>
  //           <InputGroup border="1px solid white" display="flex" flexDirection="column" alignItems="center">
